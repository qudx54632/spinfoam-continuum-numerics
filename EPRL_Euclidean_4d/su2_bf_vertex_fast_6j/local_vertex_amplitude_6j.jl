...
`su2_bf_vertex/local_vertex_amplitude.jl`.  It gives a faster 6j expression
for the same local convention, and should be validated against the 3j
contraction before being used elsewhere.
"""
