...
This file gives the same coefficient as `recoupling_R` in `recoupling.jl`,
but avoids the magnetic-label overlap sum.  The old 3j-overlap definition
remains the reference convention.
"""
